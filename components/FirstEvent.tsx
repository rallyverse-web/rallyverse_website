      ...
      <div className="mx-auto grid max-w-[1100px] grid-cols-1 gap-10 px-6 md:grid-cols-2 md:gap-16 md:items-start">
        <AnimatedSection>
          ...
          <div className="mt-7 space-y-5 font-body text-base leading-[1.85]" style={{ color: 'var(--text-muted)' }}>
            <p>
              RallyVerse is a sports growth partner. We don&apos;t just consult on community — we design and power sports events with our registration, payment management, attendance tracking, and communication platform, powered by an active participant network.
            </p>
            <p>
