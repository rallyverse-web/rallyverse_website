        ...
        >
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="font-body text-sm md:text-base mt-4 max-w-2xl leading-relaxed" style={{ color: 'var(--text-muted)' }}>
              RallyVerse helps sports organizers manage registrations, participant communication, and sports event marketing initiatives — from badminton tournaments to community sports events.
            </p>
          </div>
        </motion.div>
